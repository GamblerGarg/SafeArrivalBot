...
public class Main {
    ...
    public static void main(String[] args) throws LoginException, InterruptedException {
    	...
    	String token = "ODE3MzQxNTcyMTA1MzcxNjY4.YEIGqA.hwqLEvvylePtdWvDuHkBHkqVLDU";  // Please insert the token for your bot here. 
        ...
        builder.setActivity(Activity.watching("~info"));
